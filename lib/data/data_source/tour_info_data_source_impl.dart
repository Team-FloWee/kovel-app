...
class TourInfoDataSourceImpl implements TourInfoDataSource {
  ...
  Future<List<TourDto>> getAreaBasedList() async {
    ...
    response = await _dio.get('$baseUrl/$apiName?MobileOS=$_modileOs&MobileApp=MobileApp&_type=json&serviceKey=$key');
  ...
  Future<List<TourDto>> getLocationBasedList(String mapX, String mapY, String radius) async {
    ...
    final Response response;
    response = await _dio.get('$baseUrl/$apiName?MobileOS=$_modileOs&MobileApp=MobileApp&_type=json&mapX=$mapX&mapY=$mapY&radius=$radius&serviceKey=$key');
  ...
  Future<List<TourDto>> getSearchFestival(String eventStartDate) async {
    ...
    final Response response;
    response = await _dio.get('$baseUrl/$apiName?MobileOS=$_modileOs&MobileApp=MobileApp&_type=json&eventStartDate=$eventStartDate&serviceKey=$key');
  ...
  Future<List<TourDto>> getSearchKeyword(String keyword) async {
    ...
    final Response response;
    response = await _dio.get('$baseUrl/$apiName?MobileOS=$_modileOs&MobileApp=MobileApp&_type=json&keyword=$keyword&serviceKey=$key');
  ...
  Future<List<TourDetailDto>> getDetailCommon(String contentId) async {
    ...
    Response response;
    response =
        await _dio.get('$baseUrl/$apiName?MobileOS=$_modileOs&MobileApp=MobileApp&_type=json&contentId=$contentId&areacodeYN=Y&catcodeYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&serviceKey=$key');
  ...
  Future<List<ContentDetailDto>> getDetailIntro(String contentId, String contentTypeId) async {
    ...
    final Response response;
    response = await _dio.get('$baseUrl/$apiName?MobileOS=$_modileOs&MobileApp=MobileApp&_type=json&contentId=$contentId&contentTypeId=$contentTypeId&serviceKey=$key');
