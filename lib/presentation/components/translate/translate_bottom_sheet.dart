...
class TranslateBottomSheet extends StatefulWidget {
  ...
  const TranslateBottomSheet({super.key, required this.text, required this.scrollController});
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      Container(
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(color: UiConfig.black.shade100, borderRadius: BorderRadius.circular(16)),
                        child: Column(
                          ...
                          children: [
                                ...
                                : Row(
                                    children: [
                                      ...
                                      InkWell(
                                          ...
                                          child: Text('more', style: UiConfig.bodyStyle.copyWith(color: UiConfig.primaryColor, fontWeight: UiConfig.semiBoldFont)))
                                    ],
                                  ),
                            const SizedBox(height: 16),
                            ...
                            _buildTranslatedSection(isMore: _isMore, translatedData: aiProvider.translatedData, controller: widget.scrollController)
                          ],
                        ),
                      ),
...
Widget _buildTranslatedSection({required bool isMore, required String translatedData, required ScrollController controller}) {
  return Stack(
    children: [
      Opacity(
      ...
      isMore
          ? Padding(
              ...
              child: Column(
                children: [
                  Text(translatedData, style: UiConfig.h4Style.copyWith(fontWeight: UiConfig.semiBoldFont)),
                ],
              ),
            )
          : Container(
